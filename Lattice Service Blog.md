...
This provided a very cost efficient and easily maintainable solution while only a small number of customers required cloud deployments. With an increasing demand for SaaS offerings by Deswik customers, a number of shortcoming become evident:
